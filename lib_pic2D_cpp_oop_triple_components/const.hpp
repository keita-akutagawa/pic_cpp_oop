...
extern const int harrisNumIon;
extern const int backgroundNumIon;
extern const int backgroundNumHeavyIon;
extern const int harrisNumElectron;
extern const int backgroundNumElectron;
...
extern const double vThIonB;
extern const double vThElectronB;
extern const double vThHeavyIonB;
extern const double bulkVxIonB;
extern const double bulkVyIonB;
extern const double bulkVzIonB;
extern const double bulkVxHeavyIonB;
extern const double bulkVyHeavyIonB;
extern const double bulkVzHeavyIonB;
extern const double bulkVxElectronB;
extern const double bulkVyElectronB;
extern const double bulkVzElectronB;
